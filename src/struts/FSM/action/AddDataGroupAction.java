 ...
 * 
 * XDoclet definition:
 * @struts.action path="/addDataGroup" name="dataGroupForm" scope="request" validate="true"
 ...
 */
public class AddDataGroupAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		/*从form表单中获取DataGroup信息,赋值给实体Bean*/
		...
		/*调用业务层,添加数据组*/
		boolean result = mp.insertDataGroup(fdg);
		if(result=true){
