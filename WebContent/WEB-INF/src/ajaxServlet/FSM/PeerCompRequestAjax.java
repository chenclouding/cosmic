...
public class PeerCompRequestAjax extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public PeerCompRequestAjax() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Iterator it = null;
		try {
			it = sp.getPeerComponentByLayerIdAndCompType(1,layerId).iterator();
		} catch (HibernateException e) {
			// TODO Auto-generated catch block			e.printStackTrace();
		}
        String value = "";
        while(it.hasNext()){
          FsmPeerComponent fpc = (FsmPeerComponent)it.next();
          value = value+fpc.getId()+','+fpc.getPeerCompName()+',';	
     	}
