...
<html>
  <head>
    ...
    <title>My JSP 'editDataMoveOfFuncPros.jsp' starting page</title>
...
%>
       ...
       <%}else{ %>
        ...
        <% for(Object obj:dataMoveList){ 
	         ...
	         <tr>
		          ...
		          <td><a href="/fsmch/FSM/cosmicStandard/measure/delDataMovement1.jsp?funcProsId=<%=funcProsId%>&dataMoveId=<%=dataMoveId%>" onclick="return confirmdel();"><IMG src="/fsmch/images/btndel.gif" alt="删除" border="0" /></a></td>
	         </tr>  
          <%}%>
         </table>
        <% }%> 
     ...
     <hr> 
     <form name="form1" action="/fsmch/FSM/addDataMoveOfFuncPros.do" onSubmit="return verifyInput();"> 
      <table>
         <tr>
