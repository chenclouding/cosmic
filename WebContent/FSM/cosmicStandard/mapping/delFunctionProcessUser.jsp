...
<html>
  ...
  <body>
   ...
   <%
      ...
      Integer funcProsId =  new Integer(request.getParameter("funcProsId"));//获取从页面functionProcessUser.jsp传来funcProsId
      ...
      if(ms!=0){ //若该功能流程已经被部分度量或者全部度量，则不能被删除此关联
           ...
           ffp.setMappingUserStatus(0); //更改功能流程的MappingEventStatus为0，表示已经取消功能流程-事件的映射
