...
<html>
  <head>
    ...
    <title>My JSP 'eventBasicInfo.jsp' starting page</title>
 ...
 <link rel="stylesheet" type="text/css" href="/fsmch/images/screen.css">
  ...
  <% 
   ...
   FsmEvent fe =(FsmEvent) mp.getEventById(eventId);
   ...
   <h1> 软件描述</h1>
    <table>
      <tr> 
       ...
       <tr> 
          <td width="15%">事件名称:</td> <td><%=fe.getEventName()%></td>
      </tr>
      <tr> 
          <td width="15%">事件描述:</td> <td><%=fe.getEventDesp()%></td>
      </tr>
