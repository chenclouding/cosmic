...
<html>
  <head>
    ...
    <title>My JSP 'interestObjBasicInfo.jsp' starting page</title>
 ...
 <link rel="stylesheet" type="text/css" href="/fsmch/images/screen.css">
  ...
  <% 
   ...
   Integer interestObjId = (Integer)session.getAttribute("interestObjId");
   //按照各自ID将名称取出来
   ProductMeasureBusiness pmb = new ProductMeasureBusiness();
   StrategyPhase sp = new StrategyPhase();
   MappingPhase mp = new MappingPhase();
   FsmInterestObject fio =(FsmInterestObject) mp.getInterestObjectById(interestObjId);
   ...
   <h1> 软件描述</h1>
    <table>
      <tr> 
       ...
       <tr> 
          <td width="15%">兴趣对象名称:</td> <td><%=fio.getInterestObjName()%></td>
      </tr>
      <tr> 
          <td width="15%">兴趣对象描述:</td> <td><%=fio.getInterestObjDesp()%></td>
      </tr>
