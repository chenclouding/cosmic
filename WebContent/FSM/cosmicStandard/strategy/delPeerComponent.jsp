...
<html>
  ...
  <body>
   <%
      Integer layerId = new Integer(request.getParameter("layerId"));//获取从页面peerComponent.jsp传来layerId,用于转跳回到peerComponent.jsp
      Integer peerCompId = new Integer(request.getParameter("peerCompId"));//获取从页面peerComponent.jsp传来peerCompId,用于删除操作
