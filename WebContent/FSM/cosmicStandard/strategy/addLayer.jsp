...
<html>
  <head>
    ...
    <title>My JSP 'addLayer.jsp' starting page</title>
   ...
   %>
    <table>
     <tr>
       <td>
       ÇëÑ¡Ôñ²úÆ·
		    <form  action="/fsmch/FSM/cosmicStandard/strategy/layer.jsp"  method="post" target="staregyFrame" >
	...
	<hr>
    <iFrame name="staregyFrame" frameborder="0" height="800px" width="100%" scrolling="auto"/>
  </body>
</html>
