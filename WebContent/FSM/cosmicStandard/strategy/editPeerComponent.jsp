...
<html>
  <head>
    ...
    <title>My JSP 'editPeerComponent.jsp' starting page</title>
  ...
  <body>
      <%
       /*获取从页面addSubPeerComponent.jsp传来peerCompId和layerId\fatherId*/
  ...
  <form action="/fsmch/FSM/editPeerComponent.do" name="peerCompForm" method="post" onSubmit="return verifyInput(<%=peerCompUn%>,<%=peerCompPart%>,<%=peerCompAll%>,<%=funcProsUn%>,<%=funcProsPart%>,<%=funcProsAll%>,<%=funcDel%>,<%=peerCompDel%>);">
      <table>
         <tr>
